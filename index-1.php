...
if (empty($products)) {
    ...
    // DRINKS
    ["id"=>12, "name"=>"Cold Brew",          "price"=>160, "category"=>"drinks", "image"=>"", "description"=>"Steeped 18 hours in cold water for a smooth, naturally sweet concentrate over ice."],
    ["id"=>13, "name"=>"Iced Americano",     "price"=>110, "category"=>"drinks", "image"=>"", "description"=>"Double espresso pulled over ice and chilled water — clean, crisp, and refreshing."],
    ["id"=>14, "name"=>"Iced Caramel Latte", "price"=>165, "category"=>"drinks", "image"=>"", "description"=>"Chilled latte with caramel syrup and milk poured over a glass of crushed ice."],
    ["id"=>15, "name"=>"Matcha Latte",       "price"=>150, "category"=>"drinks", "image"=>"", "description"=>"Ceremonial-grade matcha whisked with oat milk — earthy, smooth, and lightly sweet."],
    ["id"=>16, "name"=>"Iced Mocha",         "price"=>155, "category"=>"drinks", "image"=>"", "description"=>"Chilled blend of espresso, chocolate syrup, and milk served over ice."],
    ["id"=>17, "name"=>"Dirty Matcha",       "price"=>165, "category"=>"drinks", "image"=>"", "description"=>"Layered drink of matcha and espresso with milk for a bold, earthy caffeine kick."],
    ["id"=>18, "name"=>"Espresso Tonic",     "price"=>150, "category"=>"drinks", "image"=>"", "description"=>"Refreshing mix of espresso and tonic water served over ice with citrus notes."],

    // SIDES
    ["id"=>19, "name"=>"Croissant",          "price"=>95,  "category"=>"sides", "image"=>"", "description"=>"Buttery, flaky all-butter croissant baked fresh every morning."],
    ["id"=>20, "name"=>"Banana Bread",       "price"=>80,  "category"=>"sides", "image"=>"", "description"=>"Moist homemade banana bread with a golden crust, perfect with your morning coffee."],
    ["id"=>21, "name"=>"Blueberry Muffin",   "price"=>85,  "category"=>"sides", "image"=>"", "description"=>"Fluffy muffin bursting with fresh blueberries and a crumbly sugar topping."],
    ["id"=>22, "name"=>"Cinnamon Roll",      "price"=>110, "category"=>"sides", "image"=>"", "description"=>"Soft, sweet pastry swirled with cinnamon sugar and topped with light icing."],
    ["id"=>23, "name"=>"Chocolate Chip Cookie","price"=>70,"category"=>"sides","image"=>"","description"=>"Freshly baked cookie loaded with rich chocolate chips and a soft chewy center."],
    ["id"=>24, "name"=>"Ham & Cheese Panini","price"=>140,"category"=>"sides","image"=>"","description"=>"Grilled panini stuffed with savory ham and melted cheese."],
    ["id"=>25, "name"=>"Breakfast Sandwich", "price"=>150, "category"=>"sides", "image"=>"", "description"=>"Toasted sandwich with egg, cheese, and choice of ham or bacon for a filling start."],

    // DESSERTS
    ["id"=>26, "name"=>"Tiramisu",           "price"=>130, "category"=>"desserts", "image"=>"", "description"=>"Classic Italian dessert with espresso-soaked ladyfingers and mascarpone cream."],
    ["id"=>27, "name"=>"Chocolate Lava Cake","price"=>145, "category"=>"desserts", "image"=>"", "description"=>"Warm dark chocolate cake with a molten centre, served with a dusting of cocoa powder."],
    ["id"=>28, "name"=>"Affogato",          "price"=>140, "category"=>"desserts", "image"=>"", "description"=>"Vanilla ice cream drowned in a hot shot of espresso for a perfect hot-and-cold dessert."],
    ["id"=>29, "name"=>"Cheesecake",        "price"=>135, "category"=>"desserts", "image"=>"", "description"=>"Creamy baked cheesecake with a buttery graham crust."],
    ["id"=>30, "name"=>"Brownies",          "price"=>90,  "category"=>"desserts", "image"=>"", "description"=>"Fudgy chocolate brownies with a crackly top and rich cocoa flavor."],
    ];
}
    ...
    $productsPaginated = array_slice($products, $offset, $itemsPerPage);
