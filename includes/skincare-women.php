...
$productsBySuite = [];
$sr = $conn->query("SELECT * FROM services WHERE active = 1 AND type = 'skincare' AND gender = 'women' ORDER BY suite_id ASC, id ASC");
...
function render_product_card($s, $tier, $suiteName) {
    ...
    <div class="svc-card">
        <div class="svc-media">
            ...
            <span class="svc-corner">Skincare</span>
        </div>
        <div class="svc-body">
...
<title>Skincare Shop — Women — Nocturne Manila Bay</title>
...
<div class="h-loader" id="hLoader" aria-hidden="true">
    ...
    <div class="h-loader-word">Skincare — Women</div>
</div>
...
<section class="page-hero">
    <div class="sec-eyebrow"><a href="hotel-services.php" style="color:var(--h-gold-dim);text-decoration:none">Spa, Shop &amp; Entertainment</a> / Women</div>
    <h1>Skincare Shop — <em>Women</em></h1>
    <p>A curated range of serums, creams, and treatments — distinct to each residence.</p>
</section>
...
<div class="cart-drawer" id="cartDrawer">
    ...
    <div class="cart-foot">
        ...
        <p style="font-size:12px;color:var(--h-muted);margin:12px 0">
            Please <a href="register.php?next=skincare-women.php" style="color:var(--h-gold)">create an account</a>
            or <a href="hotel-login.php?next=skincare-women.php" style="color:var(--h-gold)">log in</a> to complete your order.
        </p>
