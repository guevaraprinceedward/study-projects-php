<?php
// trending.php — identical structure, swap flag + copy
require_once __DIR__ . '/config/app.php';
require_once __DIR__ . '/includes/product-functions.php';
$page_title = "Trending Now — El Grande De La Torres";
$extra_css = SITE_URL . '/assets/css/shop.css';
require_once __DIR__ . '/includes/header.php';
$products = fetch_flagged_products('is_trending', 100);
?>
<div class="shop-header"><span class="eyebrow" style="justify-content:center;">Right Now</span><h1 class="section-title">Trending Now</h1></div>
<div class="container-lux" style="padding:3.6rem 0 6rem;">
    <div class="product-grid">
        ...
        <?php endforeach; ?>
        <?php if (empty($products)): ?><div class="empty-state"><p>No trending items yet.</p></div><?php endif; ?>
    </div>
</div>
