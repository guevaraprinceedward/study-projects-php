...
if (empty($products)) {
    $products = [
    // MAINS (12)
    ["id"=>1,  "name"=>"Espresso",              "price"=>85,  "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Espresso.Product.png", "description"=>"Bold and concentrated shot of pure espresso, brewed from freshly ground arabica beans."],
    ["id"=>2,  "name"=>"Americano",             "price"=>100, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Americano.Product-V1.png", "description"=>"Espresso diluted with hot water for a smooth, full-bodied black coffee experience."],
    ["id"=>3,  "name"=>"Cappuccino",            "price"=>130, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Cappuccino.Product.png", "description"=>"Equal parts espresso, steamed milk, and thick velvety foam — a classic Italian favourite."],
    ["id"=>4,  "name"=>"Caffè Latte",           "price"=>140, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Caffe.Latte.png", "description"=>"Silky steamed milk poured over a double shot of espresso with a light layer of foam."],
    ["id"=>5,  "name"=>"Flat White",            "price"=>145, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Flat.White.Product.png", "description"=>"Stronger and creamier than a latte — micro-foamed milk over a rich ristretto shot."],
    ["id"=>6,  "name"=>"Caramel Macchiato",     "price"=>155, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Caramel-Macchiato.Product.png", "description"=>"Vanilla-infused steamed milk, espresso, and a generous drizzle of rich caramel."],
    ["id"=>7,  "name"=>"Mocha",                 "price"=>150, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Mocha.Product.png", "description"=>"Espresso blended with chocolate syrup and steamed milk, topped with whipped cream."],
    ["id"=>8,  "name"=>"Hazelnut Latte",        "price"=>155, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Hazelnut_Latte.Product.png", "description"=>"Smooth latte infused with rich hazelnut syrup and topped with silky milk foam."],
    ["id"=>9,  "name"=>"White Chocolate Mocha", "price"=>160, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/White-Chocolate-Mocha.Product.png", "description"=>"Espresso blended with creamy white chocolate and steamed milk, topped with whipped cream."],
    ["id"=>10, "name"=>"Spanish Latte",         "price"=>150, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Spanish_Latte.Product.png", "description"=>"Sweet and creamy latte made with condensed milk for a richer flavor profile."],
    ["id"=>11, "name"=>"Vanilla Latte",         "price"=>145, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Vanilla_Latte.Product.png", "description"=>"Classic latte enhanced with smooth vanilla syrup and steamed milk."],
    ["id"=>12, "name"=>"Cortado",               "price"=>135, "category"=>"mains", "image"=>"https://raw.githubusercontent.com/guevaraprinceedward/study-projects-php/refs/heads/main/Cortado.Product.png", "description"=>"Equal parts espresso and warm milk, cutting the acidity for a balanced, velvety sip."],
